...
const MONITOR_SOURCES = [
  ...
  { name:'GEMA Kulturförderung',       url:'https://www.gema.de/kulturfoerderung-online',                 priority:'High',   type:'funding'  },
  { name:'Musikfonds',                 url:'https://www.musikfonds.de/foerderung/',                       priority:'High',   type:'funding'  },
  ...
  { name:'Berlin Senate — Musik',      url:'https://www.berlin.de/sen/kultur/foerderung/antragsfristen/',priority:'High',   type:'funding'  },
  // EU funding
      ...
      if (watchingRow) {
        ...
        const row = headers.map(h => {
          switch (h) {
            ...
            case 'Priority':     return src.priority || 'High';
